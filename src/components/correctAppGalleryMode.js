...
class App extends React.Component {
  ...
  render() {
    ...
    if(this.state.flipped === true) {
      ...
      // clear arrays 
      // console.log(galleryIndicators.length)
      // console.log(galleryItems.length)      
      // console.log(galleryIndicators, galleryItems)
    ...
    return (
      <div className="App">
        ...
        <div className="container">
          <a className="btn mybtn btn-2" data-toggle="modal" data-target={"#GalModGallery" + this.state.carList[flag].id}>Photo gallery</a>
        </div>
        <LoginForm />        
